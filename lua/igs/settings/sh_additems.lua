...
local function CreateVIP(printname, classname, time, price, discountfrom)
	...
	Скидка 50% на все временные предметы в магазине
	Увеличенные вдвое лимиты на спавны (в 10 раз для NPC)
	Возможность постоянно спавнить всех запрещенных NPC
	Возможность постоянно спавнить мэнхэк-пушку и флешетт-пушку
